...
<title>CRUD JAVA - Lista de Pedidos</title>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link" href="OrderCreateAndFind">Lista de Pedidos</a>
        </li>
      </ul>
      <form action="OrderCreateAndFind" method="GET" class="d-flex">
        <input name="pesquisa" class="form-control me-2" type="search" placeholder="Digite o ID" aria-label="Search">
